            ...
            public void run() {
                try{
                    for(int i=0; i<MAX_SEC && isRunning; i++){
                        ...
                        // This is a locally generated vakue
                        ...
                        if (isRunning){
                            // request a message token and put some date in it
